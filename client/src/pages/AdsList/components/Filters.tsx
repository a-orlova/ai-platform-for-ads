    ...
    <aside className="filters-block">
      <div className="all-filters-block">
        ...
        <div className="choose-category-block">
          <p>Категория</p>
          <button className={`open-categories-btn ${isCategoryListOpen ? 'rotated' : ''}`} onClick={toggleCategoryList}>
      ...
      <button className="reset-filters-btn" type="button" onClick={onResetFilters}>
        {' '}
        Сбросить фильтры{' '}
      </button>
    </aside>
